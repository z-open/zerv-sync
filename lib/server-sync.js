...
function notifyChanges(dataNotification, object, options) {
    logger.error('notifyChanges() is no longer supported. Use notifyCreate or notifyUpdate instead');
...
function notifyRemoval(dataNotification, object, options) {
    logger.error('notifyRemoval() is no longer supported. Use notifyDelete instead.');
