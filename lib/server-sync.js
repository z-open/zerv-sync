...
function notifyRecordActivity(tenantId, dataNotification, notificationType, object, options) {
    ...
    findPublicationsListeningToDataNotification(dataNotification)
        .forEach(function (publication) {
            publication.notifySubscriptions(tenantId, dataNotification, notificationType, object, options);
        });
}
...
Publication.prototype.notifySubscriptions = function (tenantId, dataNotification, notificationType, object, options) {
    ...
    thisPublication.formatNotifiedObject(dataNotification, object, notificationType)
        .then(function (record) {
            findSubscriptionsUsingPublication(tenantId, thisPublication.name)
