...
function syncWithRedis(processRecordNotifications, transport) {
    ...
    function onMessage(channel, message) {
        const json = transport.deserializeFromString(message);//JSON.parse(message);
    ...
    function notifyCluster(tenantId, dataNotification, notificationType, objects, options) {
        ...
        pub.publish(getChannelByTenantId(tenantId), transport.serializeToString(notificationObj));
    }
