 ...
 *    @property {Boolean} forceNotify, the data will be sent to description even though they might have the proper vision
                  ...
                  .then(async (records) => {
                    ...
                    for (const record of records) {
                      ...
                      try {
                        ...
                        const type = ! await(subscription.checkIfMatch(record, dataNotification)) ? 'REMOVAL' : notificationType;
