...
const PublicationCache = require('./publication-cache');
...
function Publication(name, fetchFn, dataNotifications, options= {}) {
    ...
    this.cache = this.incremental && new PublicationCache(name);
}
...
Publication.prototype.getCachedRecord = function(tenantId, id) {
    return this.cache.get(tenantId, id);
};

Publication.prototype.cacheRecordRevision = function(tenantId, record, revision) {
    return this.cache.add(tenantId, record, revision);
};
